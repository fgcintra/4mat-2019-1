...
1. Acesse o [repositório do professor](https://github.com/fgcintra/4mat-2019-1);
...
3. Em seguida, copie o código dos arquivos  `combustivel-list.component.html`, `combustivel-list.component.scss` e `combustivel-list.component.ts` do [repositório do professor](https://github.com/fgcintra/4mat-2019-1) e cole nos arquivo gerados, **de acordo com seus tipos**, substituindo o conteúdo. 
...
7. Edite a função `obterListas()` para carregar corretamente as variáveis de vetor das entidades relacionadas.
